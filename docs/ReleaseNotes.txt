...
All bugfixes and improvements from XRootD 5.9.7 are also in XRootD 6.1.1.

+ **Bugfixes**
  **[XrdClHttp]** Fix errors in complex vectored reads (#2858)
  **[XrdClS3]** Fix use-after-move crash when synchronous read fails (#2790)
  **[XrdCl]** Fix deadlock in poller after fork handler has run (#2879)
  **[XrdCl]** Fix wrong path when falling back to load-balancer (#2394)
  **[XrdHttpTpc]** Fix double close of file descriptor (#2889)
  **[XrdHttpTpc]** Fix flush of destination file in multistream mode (#2891)
  **[XrdHttp]** Fix invalid XML output in HTTP monitoring streams (#2843)
  **[XrdPfc]** Fix snprintf handling in config printout (#2860)

+ **Miscellaneous**
  **[CI]** Tolerate transient CDash upload failures (#2880)
  **[Tests]** Add bundled GoogleTest, GoogleMock, and BATS frameworks (#2849, #2851)
  **[XrdClS3]** Enable prefeth in full download for chunked encoding (#2850)
  **[XrdCl]** Switch to new constructors to initialize XrdCl::File (#2848)

-------------
Version 6.1.0
-------------

All bugfixes and improvements from XRootD 5.9.6 are also in XRootD 6.1.0.

+ **New Features**
  **[Python]** Add functions to delete variables from client environment (#2829)
  **[Python]** Expose complete stat info in Python bindings (#2823)
  **[Server]** Add support for streaming real-time checksums (#2806)
  **[XrdCrypto/XrdTls/XrdVoms]** Add support for OpenSSL 4.0 (#2802)
  **[XrdOssMirage]** New server-side plugin that simulates the existence of files (#2818)
  **[XrdHttpTPC]** Enable redirect plugin for SENSE in HTTP TPC (#2767, #2788)

+ **Bugfixes**
  **[Plugins]** Add versioning rules for sec.protocol ztn
  **[Python]** Fix standalone build against an installed XRootD (#2816)
  **[Server]** Do not clamp free space to 8 PB in kXR_stat+vfs (#2753)
  **[Server]** Encrypt sessionid to prevent spoofing (#2798)
  **[Server]** Fix cmsd failures with lengthy tokens via HTTP (#2814)
  **[XrdApps]** Add missing sec.entitylib entry for xrdpinls reporting
  **[XrdHttpTPC]** Fetch IP from socket instead of using DNS resolution (#2811, #2812)
  **[Tests]** Fix header smuggling regression test for header parsing (#2826)

+ **Miscellaneous**
  **[Python]** Add client workflow examples (#2833)
...
All bugfixes and improvements from XRootD 5.9.4 are also in XRootD 6.0.2.

+ **Bugfixes**
  **[XrdPosix]** Remove duplicate definitions
  **[XrdPosix]** Disable fstatat and openat functions
  **[XrdPosix]** Fix buffer potentially not null-terminated bug in XrdResolveLink

+ **Miscellaneous**
  **[XrdHttp]** Add the resource type tag for non-collections in xml response (#2782)
...
+ **New Features**
  ...
  **[Server,XrdCl]** Add support for pre-read (#2727, #2743)
  ...
  **[XrdCl]** Added -h option to xrdfs for human-readable size listing (#2612)
...
+ **Major bug fixes**
  **[XrdHttpTPC]** Fix issue with multi-stream PULL (#2108)
  **[XrdHttpTPC]** Share one parsed CA/CRL store across transfers (#2873)
  **[XrdHttpTPC]** Improve error message when close fails on destination (#2878)

+ **Minor bug fixes**
  **[Client,Server]** Fix various Clang-Tidy and CodeQL reported issues
  **[XrdHttpTPC]** Report actual bytes transferred in performance markers (#2874)
  **[XrdXrootd]** Fix wrong port in redirect monitoring record (#2736)

+ **Miscellaneous**
  **[Docs]** Add man page for xrootd-config command
  **[XrdHttpTPC]** Make low-speed timeout configurable (#2881)
  **[XrdHttpTPC]** Allow missing CRL checking if configured via xrd.tlsca (#2681)
...
+ **Major bug fixes**
  **[XrdMacaroons]** Deny macaroons requests which fail caveats or HMAC checks
  **[XrdMacaroons]** Intersect user-requested activities with allowed activities

+ **Minor bug fixes**
  **[Tests]** Fix sporadic failures in Kerberos test fixture setup (#2822)

+ **Miscellaneous**
  **[CI]** Adjust GitHub Actions build triggers and permissions to improve security
  **[Tests]** Add tests for authentication with macaroons over HTTP (#2746)
