...
//
void XrdCms::RegisterMetrics(XrdMetrics::Collector &collector)
{
   Cluster.RegisterMetrics(collector);
   CmsState.RegisterMetrics(collector);
   RRQ.RegisterMetrics(collector);
}
...
void XrdCmsCluster::RegisterMetrics(XrdMetrics::Collector &collector)
{
...
void XrdCmsState::RegisterMetrics(XrdMetrics::Collector &collector)
{
   XrdMetrics::Subsystem &subsystem = collector.subsystem("cms");
...
void XrdCmsRRQ::RegisterMetrics(XrdMetrics::Collector &collector)
{
   XrdMetrics::Subsystem &subsystem = collector.subsystem("cms");
