...
XrdCmsRouting::theRouting initRSProuting[] =
     {{kYR_avkb,    XrdCmsRouting::isSync},
      ...
      {kYR_gone,    XrdCmsRouting::isSync | XrdCmsRouting::rawPath},
      {kYR_have,    XrdCmsRouting::isSync | XrdCmsRouting::rawPath},
...
XrdCmsRouting::theRouting initSRVrouting[] =
     {{kYR_chmod,   XrdCmsRouting::isAsync},
      ...
      {kYR_state,   XrdCmsRouting::isSync  | XrdCmsRouting::rawPath},
