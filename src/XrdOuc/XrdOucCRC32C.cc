...
/* Modification history:
        22 Nov 2019  Rename orignal crc32.c to XrdOucCRC32.cc and crc32c.h to
                     XrdOucCRC32C.hh with corresponding change to include
                     statement herein. Add required casts to allow C++
                     compilation.
 */
