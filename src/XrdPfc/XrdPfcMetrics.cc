...
//
   auto &bytes = g.counter("bytes_total", {"origin"}, {},
   ...
   m_bytes_written = &g.counter("bytes_written_total", {}, {},
                                "bytes written to the cache disk").noLabels();
   m_cksum_errors  = &g.counter("checksum_errors_total", {}, {},
                                "checksum errors fetching from origin").noLabels();

// File lifecycle events.
//
   auto &files = g.counter("files_total", {"event"}, {},
