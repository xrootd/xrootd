...
extern "C" bool XrdInitialize(char const *,char const *);
extern "C" bool XrdTerminate();
extern "C" char *XrdSysStatX(char const *);
extern "C" char *XrdExistFiles(char const *);
extern "C" char *XrdExistDirs(char const *);
extern "C" char *XrdIsFileOnline(char const *);
extern "C" bool XrdMv(char const *,char const *);
extern "C" bool XrdMkdir(char const *,int,int,int);
extern "C" bool XrdChmod(char const *,int,int,int);
extern "C" bool XrdRm(char const *);
extern "C" bool XrdRmdir(char const *);
extern "C" bool XrdPrepare(char const *,unsigned char,unsigned char);
extern "C" char *XrdDirList(char const *);
extern "C" char *XrdGetChecksum(char const *);
extern "C" char *XrdGetCurrentHost();
extern "C" bool XrdStat(char const *,long *,long long *,long *,long *);
#ifdef PERL_OBJECT
...
XS(_wrap_XrdStat) {
    {
        ...
        }
        {
            ...
            sprintf(temp,"%lld", (long long)*(arg3));
            ST(argvi) = sv_newmortal();
