...
class XrdClient : public XrdAbsClientBase {
...
private:
   ...
   struct XrdOpenInfo     fOpenPars;   // Just a container for the last parameters
                                       // passed to a Open method

   bool                   fOpenWithRefresh;
   int                    fReadAheadSize;

   struct XrdStatInfo     fStatInfo;

   bool                   fUseCache;

   XrdUrlInfo             fInitialUrl;
...
public:
   ...
   bool         Stat(struct XrdStatInfo *stinfo);
