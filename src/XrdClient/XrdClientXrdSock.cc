...
XrdClientXrdSock::XrdClientXrdSock(XrdClientUrlInfo Host, int windowsize)
{
   // Constructor
...
//_____________________________________________________________________________
XrdClientXrdSock::~XrdClientXrdSock()
{
   // Destructor
...
//_____________________________________________________________________________
void XrdClientXrdSock::Disconnect()
{
...
//_____________________________________________________________________________
int XrdClientXrdSock::RecvRaw(void* buffer, int length)
{
...
//_____________________________________________________________________________
int XrdClientXrdSock::SendRaw(const void* buffer, int length)
{
...
//_____________________________________________________________________________
void XrdClientXrdSock::TryConnect()
{
   // Try connection
