...
function( xrootd_system_check )
  ...
  if( HAVE_GETHBYXR_IN_SOCKET OR HAVE_PROTOR_IN_SOCKET OR HAVE_NAMEINFO_IN_SOCKET )
    set( SOCKET_LIBRARY "-lsocket" PARENT_SCOPE )
  else()
    set( SOCKET_LIBRARY "" PARENT_SCOPE )
  endif()
...
endfunction( xrootd_system_check )
