...
component_status( TESTS     BUILD_TESTS       TRUE )
...
message( STATUS "Build Type Flags:  " ${${BUILD_TYPE_FLAGS}} )
...
message( STATUS "XrdOssArc:         " ${STATUS_XRDOSSARC} )
...
if( FORCE_ENABLED )
  foreach(FEATURE CEPH FUSE HTTP KRB5 MACAROONS PYTHON READLINE SCITOKENS TESTS VOMSXRD XRDCL XRDOSSARC)
